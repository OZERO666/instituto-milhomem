    ...
    <footer className="bg-secondary text-white">
      ...
      <div className="container-custom py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div className="lg:col-span-1 flex flex-col gap-5">
          <Link to="/">
            <img src={logoUrl} alt="Instituto Milhomem" className="h-12 object-contain" />
          </Link>
        ...
        <div>
          ...
          <p className="text-sm text-white/50 mb-1">{config.dias_funcionamento}</p>
          <p className="text-sm font-bold text-white mb-6">{config.horario}</p>
