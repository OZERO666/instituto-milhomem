...
export function useContato(currentUser) {
  ...
  const contactForm = useForm({ mode: 'onBlur', defaultValues: { whatsapp: '', email: '', instagram: '', facebook: '', latitude: '', longitude: '', zoom: '', endereco: '', mensagem_header: '', mensagem_whatsapp: '' } });
