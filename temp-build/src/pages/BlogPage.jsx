...
const BlogPage = () => {
  ...
  const fetchArticles = useCallback(async () => {
    setLoading(true);
    try {
      let url = '/artigos?sort=-data_publicacao&expand=categoria';
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      <SEO 
        title="Blog - Dicas e Informações sobre Transplante Capilar | Instituto Milhomem"
        description="Artigos sobre transplante capilar, cuidados pós-operatórios, mitos e verdades sobre calvície. Informação de qualidade do Instituto Milhomem."
      />
      ...
      <main className="flex-grow">
        ...
        <section className="section-padding bg-muted relative">
          <div className="absolute top-0 right-0 opacity-5 pointer-events-none overflow-hidden">
            <img 
              src="https://horizons-cdn.hostinger.com/386178fc-68a2-4ae9-99a1-df6a1385b4b9/1e20c7dbf245fee0e2ca926ad4054327.png" 
              alt="" 
              className="w-96 h-96 -translate-y-14 translate-x-14" 
            />
          </div>
