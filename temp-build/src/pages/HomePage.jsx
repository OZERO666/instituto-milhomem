...
const HomePage = () => {
  ...
  const get = useCallback(
    (field) => contactConfig?.[field] ?? DEFAULTS[field],
    [contactConfig]
  );
  ...
  const heroBadge      = heroConfig?.badge?.trim() || 'Referência em Transplante Capilar — Goiânia';
  const heroTitle      = heroConfig?.titulo?.trim() || 'Transplante capilar natural e definitivo em Goiânia';
  const heroSubtitle   = heroConfig?.subtitulo?.trim()
    || 'Técnica FUE de última geração, sem cicatriz linear, com planejamento personalizado para cada paciente.';
  const heroCtaText    = heroConfig?.cta_texto?.trim() || 'Agendar Avaliação';
      ...
      <main className="flex-grow">
        ...
        <section className="relative min-h-[100dvh] flex items-center overflow-hidden">
          ...
          <div
            ...
            style={{ background: 'linear-gradient(to bottom, transparent, hsl(43 67% 53%), transparent)' }}
          />
          <div
            aria-hidden
            className="absolute -bottom-32 -left-32 w-96 h-96 rounded-full opacity-[0.06] border border-primary"
            style={{ background: 'radial-gradient(circle, hsl(43 67% 53% / 0.15), transparent 70%)' }}
          />
          ...
          <div className="container-custom relative z-10 py-24 mt-16">
            ...
            >
              ...
              <h1 className="text-5xl md:text-6xl lg:text-[4.5rem] font-extrabold text-white
                             mb-6 leading-[1.06] tracking-tight">
                {heroTitle}
              </h1>
              ...
              <div className="flex flex-wrap items-center gap-x-8 gap-y-3 mb-10
                ...
                {[
                  { icon: Shield,       label: 'Equipe médica especializada'  },
                  { icon: Award,        label: 'Resultados naturais comprovados' },
                ].map(({ icon: Icon, label }) => (
          ...
          >
            <span className="text-[9px] uppercase tracking-[0.3em]">Role</span>
            <motion.div
        ...
        <section className="section-padding bg-background relative overflow-hidden">
          <div
            aria-hidden
            className="absolute top-0 right-0 w-[500px] h-[500px] opacity-[0.025] pointer-events-none -translate-y-16 translate-x-16"
          >
            <img
        ...
        <section className="section-padding bg-muted border-t border-border/40 relative overflow-hidden">
          <div aria-hidden className="absolute right-0 bottom-0 opacity-[0.04] pointer-events-none">
            <img
              src="https://horizons-cdn.hostinger.com/386178fc-68a2-4ae9-99a1-df6a1385b4b9/1e20c7dbf245fee0e2ca926ad4054327.png"
              alt=""
              className="w-64 h-64 translate-x-1/4 translate-y-1/4"
            />
          </div>
        ...
        <section id="resultados" className="section-padding bg-muted relative overflow-hidden">
          <div
            ...
            style={{ background: 'radial-gradient(circle, hsl(43 67% 53% / 0.2), transparent 70%)' }}
          />
          <div className="container-custom relative z-10">
        ...
        <section className="section-padding bg-background overflow-hidden relative">
          ...
          <TestimonialsCarousel testimonials={testimonials} emptyMessage={labelsConfig.testimonials_empty} />
        </section>
