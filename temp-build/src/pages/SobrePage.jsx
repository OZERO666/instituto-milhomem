...
import { Award, Shield, Heart, Sparkles, CheckCircle2, Globe } from 'lucide-react';
...
const SobrePage = () => {
  const config = useSobreConfig();
  const valueIcons = [Award, Shield, Heart, Sparkles];
  const values = config.values || [];
  const team = config.team || [];
  const credentials = config.doctor_credentials || [];
    ...
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <main className="flex-grow">
        ...
        <section className="section-padding bg-secondary text-white border-y-4 border-primary relative overflow-hidden">
          <div className="absolute inset-0 opacity-5 bg-[url('https://horizons-cdn.hostinger.com/386178fc-68a2-4ae9-99a1-df6a1385b4b9/1e20c7dbf245fee0e2ca926ad4054327.png')] bg-center bg-no-repeat bg-contain"></div>
              ...
              {values.map((val, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <h3 className="text-xl font-bold mb-3 text-secondary">{val.title}</h3>
