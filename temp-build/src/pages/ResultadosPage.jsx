        ...
        <section className="section-padding bg-muted relative">
          <div className="absolute top-0 left-0 opacity-5 pointer-events-none">
            <img
              ...
              alt=""
              className="w-[400px] h-[400px] -translate-x-1/2 -translate-y-1/4"
            />
          </div>
          ...
          <div className="container-custom relative z-10">
            ...
            <div className="mt-24 bg-[#181B1E] rounded-2xl p-12 text-center border border-primary shadow-2xl relative overflow-hidden">
              <div className="absolute inset-0 opacity-10 bg-[url('https://horizons-cdn.hostinger.com/386178fc-68a2-4ae9-99a1-df6a1385b4b9/1e20c7dbf245fee0e2ca926ad4054327.png')] bg-center bg-no-repeat bg-contain" />
              <div className="relative z-10">
                <h3 className="text-3xl font-bold mb-4 text-white">Vídeos de Depoimentos</h3>
                <p className="text-white/80 mb-8 text-lg max-w-2xl mx-auto">
                  Acompanhe nossos pacientes no Instagram e veja depoimentos em vídeo sobre a experiência no Instituto Milhomem.
                </p>
                <a
