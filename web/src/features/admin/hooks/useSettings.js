...
const normalizeSettings = (source = {}) => ({
  ...
  perf_reduce_motion_mobile: source.perf_reduce_motion_mobile ?? DEFAULTS.perf_reduce_motion_mobile,
  perf_before_after_throttle: source.perf_before_after_throttle ?? DEFAULTS.perf_before_after_throttle,
  perf_header_resize_observer: source.perf_header_resize_observer ?? DEFAULTS.perf_header_resize_observer,
  perf_use_content_visibility_sections: source.perf_use_content_visibility_sections ?? DEFAULTS.perf_use_content_visibility_sections,
  perf_limit_transition_all: source.perf_limit_transition_all ?? DEFAULTS.perf_limit_transition_all,
