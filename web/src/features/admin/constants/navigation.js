...
export const ADMIN_TABS = [
  ...
  { value: 'services', icon: List, label: 'Serviços', resource: 'services', action: 'read' },
  { value: 'gallery', icon: Image, label: 'Galeria', resource: 'gallery', action: 'read' },
  { value: 'media', icon: Images, label: 'Mídia', resource: 'media', action: 'read' },
  ...
  { value: 'faq',          icon: HelpCircle,    label: 'FAQ',          resource: 'faq',    action: 'read' },
  ...
  { value: 'branding', icon: Image, label: 'Branding', resource: 'branding', action: 'read' },
  { value: 'seo', icon: Search, label: 'SEO', resource: 'seo', action: 'read' },
  { value: 'hero', icon: Layout, label: 'Hero', resource: 'hero', action: 'read' },
  { value: 'pages', icon: Globe, label: 'Páginas', resource: 'pages', action: 'read' },
  { value: 'sobre',    icon: Info,      label: 'Sobre',           resource: 'pages', action: 'read' },
  { value: 'settings', icon: Settings2,  label: 'Configurações',   resource: 'settings', action: 'read' },
];
